      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php 
            include "../../koneksi/koneksi.php";
            $query =  mysqli_query($koneksi, 'SELECT *,count(*) as jml FROM barang GROUP BY tipe_barang'); 
            $result = array([]); 
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <a href="details-tabel.php?tipe_barang=<?php echo $value['tipe_barang']; ?>"><?php  echo $value['tipe_barang']?></a>
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php
                          echo "{$value['jml']} Barang ";
                        ?>
                      </div>
                    </div>
                  </div>
