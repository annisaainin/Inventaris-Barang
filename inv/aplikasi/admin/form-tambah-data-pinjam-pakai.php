      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li><a href="data-masuk.php"><b>Data Pinjam Pakai</b></a> / Tambah Peminjaman</li>
          </ol> 
          <!-- Page Heading -->                 
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
              <div class="card-body">
                <form action="pro-tambah-data-pinjam.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  $kode_pinjam = $max_ids+1;
                  $auto = $kode.sprintf("%05s", $kode_pinjam);
                  ?>
                  <input class="form-control" type="hidden" name="kode_pinjam" placeholder="ID" value="<?php echo $auto; ?>" readonly />                                  
                  ...
                  <div class="form-group">
                    <label class="col-lg-9">Tanggal Pinjam</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Tanggal Pinjam" type="date" name="tgl_pinjam" required="">
                      </div>
                  </div>
                   <div class="form-group">
                    <label class="col-lg-9">Tanggal Kembali</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Tanggal Pinjam" type="date" name="tgl_kembali">
                      </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-9">Peminjam</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Nama Peminjam" type="varchar" name="peminjam" required="">
                      </div>
                  </div> 
                  <div class="form-group">
                      ...
                      <div class="col-lg-6">
                        <select class="form-control" name="status_id"  required>
                          <option value=""> --- Pilih Status Barang --- </option>
                              <?php
                                include "../../koneksi/koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * FROM status_pinjam");
                                  while ($data=mysqli_fetch_array($query)){
                                  ?>
                                  <option value="<?php echo $data['status_id']; ?>"><?php echo $data['jenis_status']; ?></option>
                                  <?php
                                  }
                                ?>
                            </select>
                  ...
                  <div class="form-group">
                    <label class="col-lg-9">Upload Bukti</label>
                      <div class="col-lg-6">
                        <input placeholder="Upload Bukti" type="file" name="file_tandaterima" style="display:block" required="">
                      </div>
                  </div>                 
