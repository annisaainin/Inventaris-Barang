        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
              <div class="card-body">
                <form action="pro-tambah-tipe.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  <input class="form-control" type="hidden" name="id_tipe" placeholder="ID" value="<?php echo $auto; ?>" readonly />
                  <div class="form-group">
                    <label class="col-lg-9">Tipe Barang</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Tipe Barang" type="varchar" name="tipe_barang" required="">
                      </div>
                  </div>
