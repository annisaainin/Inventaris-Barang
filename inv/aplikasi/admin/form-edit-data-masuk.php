        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
              <div class="card-body">
                <?php 
                  $data=mysqli_query($koneksi,"SELECT * from masuk b inner join barang j on b.noseri=j.noseri group by b.kode_masuk");
                ...
                <form action="pro-edit-barang.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="col-lg-9">Kode Masuk</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Nama Barang" type="varchar" value="<?php echo $r['kode_masuk']; ?>" name="kode_masuk" required="" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-lg-9">Tanggal Masuk</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Tipe Barang" type="date" value="<?php echo $r['tgl_masuk']; ?>" name="tgl_masuk" required="" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-9">Pengirim</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Nama Barang" type="varchar" value="<?php echo $r['pengirim']; ?>" name="pengirim" required="" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-lg-9">Surat Masuk</label>
                      <div class="col-lg-6">
                        <input class="form-control form-control-user" placeholder="Masukkan Jumlah Barang" type="varchar" value="<?php echo $r['suratmasuk']; ?>" name="suratmasuk" required="">
                      </div>
                  </div>
                  <div class="form-group">
